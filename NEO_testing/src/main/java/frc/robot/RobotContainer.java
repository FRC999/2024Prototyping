...
import frc.robot.subsystems.NeoBranchSubsystem;
...
public class RobotContainer {
  ...
  public static final NeoBranchSubsystem neoBranchSubsystem = new NeoBranchSubsystem();
  ...
  private void configureBindings() {
    ...
    new JoystickButton(joystick, 5)
        .whileTrue(new InstantCommand(()->RobotContainer.neoBranchSubsystem.runShooterWithPower(0.2), RobotContainer.neoBranchSubsystem))
    ...
    new JoystickButton(joystick, 3)
        .whileTrue(new InstantCommand(()->RobotContainer.neoBranchSubsystem.setPositionPID(5000), RobotContainer.neoBranchSubsystem))
        .onFalse(new InstantCommand(RobotContainer.neoBranchSubsystem::stopShooter, RobotContainer.neoBranchSubsystem));
    new JoystickButton(joystick, 4)
        .whileTrue(new InstantCommand(()->RobotContainer.neoBranchSubsystem.setPositionPID(4000), RobotContainer.neoBranchSubsystem))
        .onFalse(new InstantCommand(RobotContainer.neoBranchSubsystem::stopShooter, RobotContainer.neoBranchSubsystem));
